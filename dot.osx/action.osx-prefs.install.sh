...
#------------------------------------------------------------------------------#
#-- Name     : dot.macos
#-- Purpose  : Sets OSX specific prefernces and such
#-- Author   : EM Winterschon
#-- Repo     : https://github.com/em-winterschon/dotfiles
#-- Requires : N/A
#------------:
#-- Date     : 2017-02-17
#-- Version  : 1.0 -- a subset of dotfiles project, ref: changelog for details
#------------------------------------------------------------------------------#
#-- Note     : Some aspects attributed to the following repo
...
# Set UTF8 as standard encoding on files
...
sudo cp Dropbox/Documents/wallpapers/default-background.jpg /System/Library/CoreServices/DefaultDesktop.jpg
...
# Remove the sleep image file to save disk space... Create a zero-byte file instead... …and make sure it can’t be rewritten
...
# Finder: show hidden files by default true/false
...
# Show item info under the icons on the desktop
...
# Add a dock stack that contains a dynamic list of recently accessed applications
...
# Install our dotfiles iTerm2 profile info
sudo cp -f ~/Projects/dotfiles/dot.iterm2/com.googlecode.iterm2.plist ~/Library/Application\ Support/iTerm2/DynamicProfiles/
